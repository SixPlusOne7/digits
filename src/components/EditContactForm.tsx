          ...
          <Card>
            <Card.Body>
              <Form onSubmit={handleSubmit(onSubmit)}>
                <input type="hidden" {...register('id')} defaultValue={contact.id} />
                <Form.Group>
                ...
                <input type="hidden" {...register('owner')} defaultValue={contact.owner} />
                <Form.Group className="form-group">
                  <Row className="pt-3">
                    ...
                    <Col>
                      <Button type="button" onClick={() => reset(contact)} variant="warning" className="float-right">
                        Reset
                      </Button>
                    </Col>
                  </Row>
